    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box">
                    <form class="form-horizontal" action="<?php echo base_url()?>Home/tambahlaporandosen" method="post" onsubmit="return required();">
                        <div class="box-body">
