    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="glyphicon glyphicon-user"></i> <span>DATA MAHASISWA</span>
                        <span class="pull-right-container">
                                 <i class="fa fa-angle-left pull-right"></i>
                                 </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url()?>Home/inputpresensiMahasiswa"><i class="glyphicon glyphicon-record"></i> + Presensi Mahasiswa</a></li>
                    </ul>
                <li>
                                ...
                                <table id="example1" class="table table-bordered table-striped data">
                                    ...
                                    foreach ($lunas->result() as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><center><strong><font style="color: #000000"><img height=50 width=50  src='<?php echo base_url(); ?>uploads/<?php echo $value->Pola_Jari; ?>'</font></strong></center></td>
