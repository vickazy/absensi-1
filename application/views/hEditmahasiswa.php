    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box">
                    <form class="form-horizontal" action="<?php echo base_url()?>Home/editMahasiswa" method="post" onsubmit="return required();">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" class="form-control" id="jumlah"
