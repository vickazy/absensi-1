    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="glyphicon glyphicon-user"></i> <span>LAPORAN MAHASISWA</span>
                        <span class="pull-right-container">
                                 <i class="fa fa-angle-left pull-right"></i>
                                 </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url()?>Home/inputlaporanMahasiswa"><i class="glyphicon glyphicon-record"></i> + Laporan Mahasiswa</a></li>
                    </ul>
                <li>
                                ...
                                <table id="example1" class="table table-bordered table-striped data">
                                    ...
                                    foreach ($lunas->result() as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <center>
                                                  <a href="<?php echo base_url() ?>Home/deleteLaporanMahasiswa<?php echo $value->NIM_Mahasiswa ?>" class="btn btn-danger btn-md">
                                                    <span class="glyphicon glyphicon-trash"></span>
                                                  <a href="<?php echo base_url() ?>Home/editLaporanMahasiswa/<?php echo $value->NIM_Mahasiswa ?>" class="btn btn-success btn-md">
