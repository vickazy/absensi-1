    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box">
                    <form class="form-horizontal" action="<?php echo base_url()?>Home/editLaporanMahasiswa" method="post" onsubmit="return required();">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">NIM</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control"
                                           name="NIM_Mahasiswa"  required="true">
                                </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-6">
                                      <input type="text" class="form-control"
                                             name="sakit"  required="true">
                                  </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Izin</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control"
                                               name="izin"  required="true">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputEmail3" class="col-sm-3 control-label">Alpha</label>
                                      <div class="col-sm-6">
                                          <input type="text" class="form-control"
